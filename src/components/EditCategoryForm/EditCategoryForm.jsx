...
export const EditCategoryForm = ({ handleOpen, setOpen, open, handleSnackbar,handleEditCategoryForm, handleCloseEditCategoryForm}) => {
	...
	return <CustomModal handleOpen={handleEditCategoryForm} handleClose={handleClose} open={open}>
		<div className="flex flex-col h-full w-full ">
			<label className="user-details-text" style={{ color: "black" }}>Edit Category Details:</label>

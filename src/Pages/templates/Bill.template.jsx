...
import { CartTotalAmount, getOrderListForPrint, getUserDetilasObject, successfulOrderTotalAmount } from "../../utility/SessionStorage"
...
export const BillTemplate = ({CompleteOrder}) => {
    ...
    <div className=" w-full h-10/12 flex flex-col items-center gap-2 py-4 justify-center bg-gray-400 font-medium">
        ...
        <div className="w-full h-9/12">
            <div className="Billing-Section flex flex-col w-full items-start ml-3">
